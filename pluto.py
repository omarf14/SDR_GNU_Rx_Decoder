...
class pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb('1011100111111000101100100010000010110001110011110001001010111100', 14, 'ac_found')
        ...
        self.analog_pwr_squelch_xx_0 = analog.pwr_squelch_cc((-65), (1e-4), True, True)
